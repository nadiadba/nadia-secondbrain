...
```mermaid
flowchart LR
    A["Dadaismo<br/>caso, provocazione"] --> D["Surrealismo<br/>1924"]
    B["Freud<br/>inconscio, sogno"] --> D
    C["De Chirico<br/>Metafisica"] --> D
    D --> E["Surrealismo astratto<br/>Mirò, Ernst"]
    D --> F["Surrealismo figurativo<br/>Magritte, Dalì"]
```
...
!!! example "Blu II (1961)"
    Fa parte di un trittico — *Blu I, II, III* — di tre enormi tele dipinte di un blu cobalto profondo e attraversate da pochissimi segni: in *Blu II* una serie di puntini neri allineati orizzontalmente e una piccola virgola rossa. Sembra incredibilmente poco, eppure il quadro funziona: il blu è uno spazio infinito, mentale, in cui i pochi segni sembrano suggerire una scrittura, una traiettoria, un evento. Mirò ha lavorato a queste tele in totale silenzio, descrivendole come una **meditazione**: il vuoto non è assenza, ma spazio aperto in cui l'inconscio può respirare. È l'opposto della pittura "carica" di Dalì: qui meno c'è, più c'è.
...
!!! example "Il tradimento delle immagini (1929)"
    Il quadro mostra una **pipa** dipinta in modo realistico, su sfondo neutro. Sotto, una scritta accuratissima in francese: *«Ceci n'est pas une pipe»*, "Questo non è una pipa". Sembra un controsenso, ma è verissimo: quella **non è una pipa**, è il *dipinto* di una pipa. Non si può fumare. Magritte ci mette davanti al fatto, banale ma rivoluzionario, che un'immagine non è la cosa rappresentata, e che noi confondiamo continuamente le due. È una riflessione su segno e referente — sul rapporto tra parola, immagine e realtà — che anticipa di decenni temi della **semiotica** e della filosofia del linguaggio. Il quadro è uno dei più citati del Novecento, anche al di fuori dell'arte.
...
!!! example "La persistenza della memoria (1931)"
    È il quadro surrealista più famoso del mondo. Una spiaggia silenziosa al tramonto, con le scogliere di Cap de Creus in Catalogna sullo sfondo. In primo piano tre **orologi molli**, che si afflosciano come formaggio fuso su un ramo d'albero secco, sul bordo di un parallelepipedo, sopra una creatura ambigua che sembra il profilo del volto di Dalì stesso. Un quarto orologio, chiuso e coperto di formiche, rappresenta la corruzione del tempo. È un quadro piccolissimo (24×33 cm) ma perfettamente lavorato. Il significato: il tempo, che noi pensiamo rigido e oggettivo, nei sogni si dilata, si scioglie, perde forma. Dalì disse che l'idea gli era venuta osservando del **camembert** sciogliersi al sole. Influenze diverse: la teoria della relatività di Einstein (il tempo come grandezza relativa), la filosofia di Bergson (il tempo come durata interiore), e la Metafisica di De Chirico (paesaggi onirici con orologi sospesi).
...
- **Filosofia/Psicologia**: il legame fondamentale è con **Freud** e la psicoanalisi: l'inconscio, il sogno come via per accedere ai contenuti rimossi, l'interpretazione dei simboli, la sessualità. Il Surrealismo è in pratica la traduzione visiva della *Interpretazione dei sogni* (1900).
- **Filosofia**: l'idea di tempo come durata interiore in **Bergson** torna negli orologi molli di Dalì.
- **Italiano**: il rapporto tra realtà e illusione, l'io frantumato e le maschere si possono confrontare con **Pirandello** (*Uno, nessuno e centomila*, *Il fu Mattia Pascal*); l'esplorazione dell'inconscio e del sogno con **Svevo** (*La coscienza di Zeno*, dove Zeno scrive proprio per il proprio psicoanalista). Anche la poesia di **Ungaretti** e **Montale** dialoga col surreale, soprattutto in alcune liriche di *Sentimenti del tempo* o nelle visioni di *Ossi di seppia*.
- **Storia**: il Surrealismo è anche un movimento politico: Breton aderisce al comunismo, molti surrealisti sono perseguitati dai nazisti come "arte degenerata" ed emigrano negli USA durante la Seconda guerra mondiale, contribuendo alla nascita dell'**Espressionismo astratto** americano.
