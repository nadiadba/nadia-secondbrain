...
È tipica dei legami apolari ($\text{C}-\text{C}$, $\text{C}-\text{H}$, $\text{Cl}-\text{Cl}$) e richiede molta energia, di solito sotto forma di luce ultravioletta o calore. I radicali sono specie molto reattive e tendono a innescare reazioni a catena: l'esempio classico è l'omolisi del cloro, $\text{Cl}_2 \rightarrow 2\,\text{Cl}\cdot$, primo passo dell'alogenazione degli alcani.
